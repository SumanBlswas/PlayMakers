  ...
  return (
    <>
      <Menu as="div">
        ...
        >
          <Menu.Items className="absolute left-4 top-12 z-10 mt-2 w-auto origin-top-right divide-y divide-gray-100 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            ...
            <div className="py-1 bg-[#e5e7eb] p-4  flex flex-col place-items-center gap-4 pb-4">
              ...
              <Menu.Item>
                {({ active }) => (
                  <div>
                    <button className="bg-white p-0 pt-0 pb-0 pr-2 rounded-md flex place-items-center">
                      <div className=" text-green-500 text-2xl">
                        <RxDotFilled />
                      </div>
                      <h1 className="font-semibold">Hiru</h1>
                    </button>
                  </div>
                )}
              </Menu.Item>
              ...
              <Menu.Item>
                {({ active }) => (
                  <div className="flex gap-5">
                    ...
                    <p>Disallow new players to <br /> join teams during the game.</p>
                  </div>
                )}
              </Menu.Item>
            </div>
